...
func play_tutorial():
	...
	yield(show_tooltip(upgrade_arrow, 'Press this arrow to learn the next spell from the book.', true), 'completed')
	...
	yield(show_tooltip(flame_strike_button, 'Cast a flame strike.', true), 'completed')
